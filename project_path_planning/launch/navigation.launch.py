...
def generate_launch_description():
    ...
    controller_yaml = os.path.join(get_package_share_directory('project_path_planning'), 'config', 'controller_2.yaml')
    bt_navigator_yaml = os.path.join(get_package_share_directory('project_path_planning'), 'config', 'bt_navigator.yaml')
    planner_yaml = os.path.join(get_package_share_directory('project_path_planning'), 'config', 'planner_server_2.yaml')
    ...
    map_file = os.path.join(get_package_share_directory('project_mapping'), 'maps', 'project_map.yaml')
